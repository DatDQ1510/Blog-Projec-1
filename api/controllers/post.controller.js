...
export const getposts = async (req, res, next) => {
    try {
        ...
        const posts = await Post.find({
            ...
            ...(req.query.slug && { slug: req.query.slug }), // sửa 'sulg' thành 'slug'
            ...(req.query.postId && { _id: req.query.postId }),
            ...(req.query.searchTerm && {
                $or: [
                    { title: { $regex: req.query.searchTerm, $options: 'i' } }, // Tìm trong title
                    { content: { $regex: req.query.searchTerm, $options: 'i' } }, // Tìm trong content
